...
namespace SearachAppSample.Core
{
    ...
    public class CustomColorPicker
    {
        ...
        private static int[] GenerateCustomColorsFromSteelBlue()
        {
            ...
            customColors[0] = ColorToArgb(ColorUtility.SteelBlueLightest);
            customColors[1] = ColorToArgb(ColorUtility.SteelBlueLighter);
            customColors[2] = ColorToArgb(ColorUtility.SteelBlueLight);
            customColors[3] = ColorToArgb(ColorUtility.SteelBlueBase);
            customColors[4] = ColorToArgb(ColorUtility.SteelBlueDark);
            customColors[5] = ColorToArgb(ColorUtility.SteelBlueDarker);
            customColors[6] = ColorToArgb(ColorUtility.SteelBlueDarkest);
